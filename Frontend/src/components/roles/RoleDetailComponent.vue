...
>
  ...
  <template 
    v-for="module in props.record.subModules" 
    :key="module.id"
  >
    <div 
      data-eit-mb="3"
    ...
    >
      ...
      >
        ...
        >
          Crear
          <template v-if="module.canCreate">
            <font-awesome-icon 
              :icon="['fas', 'circle-check']"
              data-eit-color="green"
              data-eit-font-size="x4"
        ...
        >
          Editar
          <template v-if="module.canUpdate">
            <font-awesome-icon 
              :icon="['fas', 'circle-check']"
              data-eit-color="green"
              data-eit-font-size="x4"
        ...
        >
          Eliminar
          <template v-if="module.canDelete">
            <font-awesome-icon 
              :icon="['fas', 'circle-check']"
              data-eit-color="green"
              data-eit-font-size="x4"
