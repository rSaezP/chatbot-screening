...
<template>
  <div 
    class="eit-border--round-left-md-x60"
    data-eit-border="all"
  ...
  >
    ...
    >
      ...
      <div data-eit-flex-shrink='1'>
        <BadgeComponent
          :text="props.record.role?.name"
          :class="`${props.record.role?.className} eit-font__size--x2`"
        />
      </div>
    </div>
  </div>
...
>
    ...
    >
      ...
      <span 
        ...
        data-eit-ms="3"
      >
        {{ props.record.loginViaSso ? 'Habilitado' : 'Deshabilitado' }}
      </span>
    </li>
 </ul>
