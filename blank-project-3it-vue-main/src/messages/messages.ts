export default {
  user: {
    ...
    //Alerts
    alertInfo: { title: "Nuevo usuario", message: "Completa la información del usuario." },
    alertError: { title: "Nuevo usuario", message: "Debes <strong>llenar la información</strong> del usuario." },
    alertEnabled: { title: "Habilitar usuario", message: "¿Estás seguro <strong>que quieres habilitar</strong> este usuario?" },
    alertDisabled: { title: "Deshabilitar usuario", message: "¿Estás seguro <strong>que quieres deshabilitar</strong> este usuario?" },
  },
  role: {
    //Toast
    ...
    toastError: { title: "Hubo un error", message: "Revisa tu conexión a internet o contacta con un administrador." },
    //Alerts
    alertInfo: { title: "Nuevo rol", message: "Completa la información del rol." },
    alertError: { title: "Nuevo rol", message: "Debes <strong>llenar la información</strong> del rol." },
    alertEnabled: { title: "Habilitar rol", message: "¿Estás seguro <strong>que quieres habilitar</strong> este rol?" },
    alertDisabled: { title: "Deshabilitar rol", message: "¿Estás seguro <strong>que quieres deshabilitar</strong> este rol?" },
  },
}